...
class Sekertaris extends CI_Controller
{
  ...
  public function detail($id)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $data7 = [
        'id_surat' => $this->input->post('id'),
        'track2' => "Sekertaris KPU <br>mengirim surat ke : <br>" . $this->input->post('dis1') . "<br>" . $this->input->post('dis2') . "<br>" . $this->input->post('dis3') . "<br>" . $this->input->post('dis4') . "<br>" . $this->input->post('dis5') . "<br> Tanggal : " . date('d-m-Y'),
      ];
  ...
  public function dett($id)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $data7 = [
        'id_surat' => $this->input->post('id'),
        'track4' => "Sekertaris KPU <br> Mengirim Surat Ke : <br>" . $this->input->post('dis2') . "<br>" . $this->input->post('dis3') . "<br>" . $this->input->post('dis4') . "<br>" . $this->input->post('dis5') . "<br> Tanggal : " . date('d-m-Y'),
      ];
