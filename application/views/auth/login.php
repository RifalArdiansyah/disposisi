            ...
            <div class="col-lg">
              <div class="p-5">
                <div class="text-center">
                  <img src="<?= base_url('assets/img/KPU_Logo.png'); ?>" alt="Logo KPU" class="img-fluid" width="100px" height="100px">
                  <h5 class="text-gray-900 mb-4"><br> Selamat Datang di Sistem <br> Disposisi Surat <br> Komisi Pemilihan Umum (KPU) <br> Kabupaten Purwakarta</h5>
                ...
                <div class="text-center mt-5">
                  <h5 class="text-gray-900">Kabupaten Purwakarta</h5>
                </div>
                <!-- <div class="text-center">
