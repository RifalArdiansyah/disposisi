    ...
    <div class="col-lg-12">
      ...
      <div class="card shadow">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Notifikasi Surat Masuk Dari Sekertaris KPU</h6>
        </div>
                ...
                <tr>
                  ...
                  <?php if ($sm['status_kap'] == 0) { ?>
                    <td style="background-color : #fcfc7583; color:black">
                      <b>Disposisi Dari : Sekertaris KPU</b><br>
                  ...
                  <?php } else { ?>
                    <td style="background-color : #88a3ee66; color:black">
                      ...
                      <b>Perihal Surat :</b> <?= $sm['perihal'] ?><br>
                      <b>Asal Surat:</b> <?= $sm['instansi'] ?><br>
                      <p class="text-primary">Status : Sudah DiBaca</p>
                      <hr>
                      <b>Tanggal: <?= tgl_indo($sm['tglteri']) ?></b>
                    </td>
                  <?php } ?>
