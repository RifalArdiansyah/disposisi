...
<div class="container-fluid">
    ...
    <div class="card shadow border-left-primary border-bottom-primary">
        ...
        <div class="card-body ">
            ...
            <!-- <div class="row">
                    <div class="col-md-12"> -->
            <form action="<?= base_url(); ?>bidangi/detail/<?= $detail['id'] ?>" method="post">
                ...
                <div class="card shadow">
                    <div class="card-header bg-info text-white col-md-12">
                        Balas Pesan Ke Sekertaris KPU
                    </div>
                    <div class="card-body">

                        <div class="form-group row">
                            <label for=""> <strong>Ditujukan Kepada : Sekertaris KPU</strong></label>
                        </div>

                        <!-- <div class="form-check row ml-2">
                                            <input class="form-check-input" type="checkbox" name="dis" value="Sekertaris KPU" required>
                                            <label for="nip">Sekertaris KPU</label>
                                </div> -->
