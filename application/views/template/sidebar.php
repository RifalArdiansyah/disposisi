<!-- Sidebar -->
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient(to bottom, #282424, #333333);">
  <!-- Sidebar - Brand -->
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
    <div class="sidebar-brand-icon">
      <img src="<?= base_url('assets/img/KPU_logo.png'); ?>" height="60px" width="60px" alt="Logo">
    </div>
    <div class="sidebar-brand-text mx-3">SISFO DISPOSU</div>
  </a>
